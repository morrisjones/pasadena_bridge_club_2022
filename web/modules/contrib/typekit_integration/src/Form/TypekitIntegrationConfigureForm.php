...
class TypekitIntegrationConfigureForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['typekit_integration_id'] = [
      '#type' => 'textfield',
      '#title' => t('Web Project ID'),
      '#description' => t('Enter your Adobe Fonts Web Project ID. You can create a free account at <a href="https://fonts.adobe.com">fonts.adobe.com</a>'),
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if (!preg_match($pattern, $api_key)) {
      $form_state->setErrorByName('typekit_integration_id', t('Project ID should contain only letters and numbers'));
    }

    if (mb_strlen($api_key) != 7) {
      $form_state->setErrorByName('typekit_integration_id', t('Project ID should be 7 characters long'));
    }
  }
